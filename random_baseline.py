...
"""
Here is the Random baseline.

"""


def random_baseline(G, k, k_f, k_g, v_vec, e_vec, M_g, M_f,T=2000, k_users=5, K=1, d_target=10, 
    ...
    for t in range(T):
        ...
        k_eff = min(k_users, len(all_users))

        users = list(np.random.choice(all_users, size=k_eff, replace=False))
